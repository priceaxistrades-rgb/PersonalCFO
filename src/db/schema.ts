...
export const transactions = pgTable("transactions", {
  ...
  index("transactions_recurring_rule_idx").on(table.recurringRuleId),
  uniqueIndex("transactions_recurring_rule_date_unique").on(table.recurringRuleId, table.txnDate),
